        ...
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-file-code-o"></i> Publicar
                    <small>imágenes de la página principal de los tours</small>
                </h2>
            ...
            <div class="x_content">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-xs-12 col-sm-offset-3 col-md-offset-3">
                        <div id="tourCarousel" class="carousel slide" data-ride="carousel" style="width: 600px; height: 680px;">
                            <!-- Indicators -->
                            ...
                            <a class="left carousel-control" href="#tourCarousel" data-slide="prev">
                                <span class="glyphicon glyphicon-chevron-left"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="right carousel-control" href="#tourCarousel" data-slide="next">
        ...
        window.vmContext = new Vue({
            ...
            methods: {
                ...
                publicar: function () {
                    $.ajax({
                        type: 'POST',
                        url: '{!! route('imagen.tour_publicar') !!}',
                        data: {
