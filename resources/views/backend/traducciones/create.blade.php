                                ...
                                <div :class="{'item':true, 'form-group':true, 'has-error':errors.has('grupo')}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input :id="'grupo-'+creaRandomStr(4)" class="form-control col-md-7 col-xs-12 autocomplete_field"
                                               ...
                                               v-validate="'required|alpha_dash|min:1|max:50'" autocomplete="off">
        ...
        window.vmContext = new Vue({
            ...
            methods: {
                setInicial: function () {
                    ...
                    // console.log('setInicial ejecutado');
                },
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.errors) {
                                        ...
                                        App.showNotiSuccess('Traducción creada satisfactoriamente');
