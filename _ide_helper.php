 ...
 * Generated for Laravel 5.6.34 on 2018-08-23 19:51:50.
 *
...
namespace Voerro\Laravel\VisitorTracker\Facades { 
    ...
    class VisitStats {
        ...
        {
            \Voerro\Laravel\VisitorTracker\VisitStats::routes();
        }
        ...
        public static function query()
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::query();
        }
         ...
         * @static 
         */ 
        public static function where($field, $symbol, $value)
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::where($field, $symbol, $value);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::except($fields);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::orderBy($field, $direction);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::groupBy($field);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::sql();
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::count();
        }
         ...
         * @static 
         */ 
        public static function period($from = null, $to = null)
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::period($from, $to);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::paginate($perPage);
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::get();
        }
        ...
        {
            \Voerro\Laravel\VisitorTracker\VisitStats::visits();
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::withUsers();
        }
        ...
        {
            \Voerro\Laravel\VisitorTracker\VisitStats::latest();
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::loginAttempts();
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::bots();
        }
        ...
        public static function ajax()
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::ajax();
        }
        ...
        {
            return \Voerro\Laravel\VisitorTracker\VisitStats::unique();
        }
...
namespace  { 
    ...
    class VisitStats extends \Voerro\Laravel\VisitorTracker\Facades\VisitStats {}
